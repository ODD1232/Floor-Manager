  ...
  return (
    <div className="view-panel" style={{ maxWidth: 1040 }}>
      <div className="rec-header">
        ...
        <p className="rec-sub">
          Review Round 3-cleared candidates and approve them with digital signature.
        </p>
      </div>
      ...
      <div style={{ display: "flex", gap: 14, marginBottom: 24 }}>
        {[
          { label: "Awaiting Approval", val: filtered.length, color: "#fbbf24" },
          { label: "Round 3 Queue", val: filtered.length, color: "#818cf8" },
          { label: "Ready for Sign-off", val: filtered.length, color: "#4ade80" },
        ].map((s) => (
          <div
            key={s.label}
            style={{
      ...
      {loading ? (
        ...
        <div className="rec-empty">
          ...
          <p>No candidates are waiting for department approval.</p>
        </div>
      ) : (
        <>
          <div
          ...
          >
            Awaiting Approval — {filtered.length}
          </div>
          ...
          <div className="rec-modal" style={{ maxWidth: 520 }}>
            ...
            <div className="rec-field" style={{ marginBottom: 16 }}>
              <label className="rec-label">
                Digital Signature{" "}
                <span style={{ color: "var(--text-muted)", textTransform: "none", fontWeight: 400, fontSize: "0.7rem" }}>
                  (image file)
                </span>
              </label>
